...
a program where you can find out does someone who you follow, follow you back. The program uses Jsoup library by parsing different information.
...
#KanjiCollector 
is a program which uses Jsoup to parse different information from memrise (studying page). 
